...
func (s *PostgresStorage) logChange(ctx context.Context, userID, entityID, action string) error {
	_, err := s.db.ExecContext(ctx,
		`INSERT INTO change_log (id, entity_type, entity_id, action, client_time, device_id, user_id)
		 VALUES (gen_random_uuid(), 'task', $1, $2, NOW(), 'server', $3)`,
...
func (s *PostgresStorage) Create(ctx context.Context, t Task) (Task, error) {
	...
	if err := s.logChange(ctx, t.UserID, created.ID, "create"); err != nil {
...
func (s *PostgresStorage) Update(ctx context.Context, t Task) (Task, error) {
	...
	if err := s.logChange(ctx, t.UserID, t.ID, "update"); err != nil {
...
func (s *PostgresStorage) UpdateStatus(ctx context.Context, id, userID, status string, completedAt, archivedAt *time.Time) (Task, error) {
	...
	if err := s.logChange(ctx, userID, id, "update"); err != nil {
...
func (s *PostgresStorage) Delete(ctx context.Context, id, userID string) error {
	...
	if err := s.logChange(ctx, userID, id, "delete"); err != nil {
